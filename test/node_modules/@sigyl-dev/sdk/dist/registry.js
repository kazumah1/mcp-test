...
exports.getMCPServerUrlByName = getMCPServerUrlByName;
exports.semanticSearchMCPServers = semanticSearchMCPServers;
exports.semanticSearchTools = semanticSearchTools;
 ...
 */
function getMCPServerUrlByName(name_1) {
    return __awaiter(this, arguments, void 0, function* (name, config = {}) {
        const client = createApiClient(config);
        try {
            // TODO: Confirm endpoint on registry API
            const pkg = yield client.get(`/packages/name/${encodeURIComponent(name)}`);
 ...
 */
function semanticSearchMCPServers(query_1) {
    return __awaiter(this, arguments, void 0, function* (query, count = 1, config = {}) {
        const client = createApiClient(config);
        // TODO: Confirm endpoint on registry API
        const resp = yield client.post(`/packages/semantic-search`, { query, count });
 ...
 * @param count - number of results to return (default 1)
 */
function semanticSearchTools(query_1) {
    return __awaiter(this, arguments, void 0, function* (query, count = 1, config = {}) {
        const client = createApiClient(config);
        // TODO: Confirm endpoint on registry API
        const resp = yield client.post(`/tools/semantic-search`, { query, count });
        return Array.isArray(resp) ? resp : [];
    });
}
